#!/usr/bin/env python3
"""
Preview script for testing modules without ESP32 communication.
Perfect for development and testing without hardware dependencies.
"""
...
def run_module_preview(module, fps=30):
    """
    Run the selected module at specified FPS for preview only.
    ...
    print(f"Starting {module.__class__.__name__} at {fps} FPS (PREVIEW MODE - NO ESP32)")
    ...
    try:
        while camera_plugin.is_opened() and (not display_plugin or display_plugin.is_active()):
            ...
            try:
                ...
                # Show preview (NO ESP32 communication)
                if display_plugin:
...
def main():
    """Main function to run the HUD inference system in preview mode."""
    print("=== HUD Inference System - PREVIEW MODE ===")
    print("(No ESP32 communication - perfect for testing)")
    ...
    try:
        ...
        # Run the module in preview mode
        run_module_preview(module)
